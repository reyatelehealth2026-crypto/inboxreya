...
**เอกสารฉบับสมบูรณ์** - เขียนอย่างละเอียด พร้อมขั้นตอน ตัวอย่าง และรูปประกอบ
...
2. พิมพ์ URL: https://reya.example.com
3. หน้าจอ Login จะแสดง
4. ใส่ Username (ชื่อผู้ใช้ที่ได้รับจาก Admin)
5. ใส่ Password (รหัสผ่าน)
...
*รูป: Dashboard หน้าแรก - สรุปสถิติหลัก*
...
├─ 🔵 Closed (จบสรรพแล้ว)
└─ 🔴 Reopened (ลูกค้าตอบกลับ)
```

**กลยุทธ์**: เริ่มจาก **Open** → ตอบทั้งหมด → เปลี่ยนเป็น **Closed**

#### 2️⃣ **ค้นหาลูกค้า**

```
🔍 Search Bar (ด้านบน)
- พิมพ์ชื่อลูกค้า: "John"
- พิมพ์เบอร์โทร: "081234567"
- พิมพ์ Tag: "VIP"
```

#### 3️⃣ **Filter by Assignment (ขั้นสูง)**

```
โปรดดู Settings > Filter
├─ Assigned to me (งานของฉัน)
├─ Assigned to [Name] (งานของคนอื่น)
...
**[Screenshot: Customer Profile Panel]**
...
**[Screenshot: Input field + Send button]**
...
**[Screenshot: Tag selection popup]**
...
### 📎 ส่วนเสริม: Attachments, Notes, VIP
...
```
1. ด้านขวาบน → คลิก "📌 Notes"
2. พิมพ์หมายเหตุ:
   "ลูกค้านี้ต้องการแบบเฉพาะ - ลองสีแดง"
3. บันทึก
```

**[Screenshot: Notes panel]**

#### ⭐ Mark as VIP

```
1. ด้านขวาบน → คลิก "⭐ Mark as VIP"
2. ลูกค้าจะมี VIP badge
3. ทุกคนจะรู้ว่าสำคัญ
```
...
**[Screenshot: Customers main page]**
...
**[Screenshot: Customer profile in Inbox]**
...
**[Screenshot: Customers list page]**
...
ดาวน์โหลด → ใช้ใน Excel/Google Sheets
```

### 👁️ ดูประวัติลูกค้า

```
1. ไป Customers → เลือกลูกค้า
2. ดานขวา → Tab "📜 Conversation History"
3. แสดง: ข้อความทั้งหมดที่เคยคุย
   (เรียงเวลา เก่า → ใหม่)
```

**[Screenshot: Conversation history]**
...
|---|---|---|
| **คือ** | ป้ายชื่อส่วนตัว | กลุ่มลูกค้า |
| **ตั้งค่าตรงไหน** | Inbox (ขณะตอบ) | Menu > Segments (ล่วงหน้า) |
| **ปกติใช้** | คลิกคนละอัน | ส่ง Broadcast |
| **ตัวอย่าง** | VIP, ติดตาม, ร้อน | "ลูกค้า Bangkok ซื้อเกิน 50K" |
| **ลบได้ไหม** | ได้ (ไม่ถাวร) | ได้ |
...
**[Screenshot: Create Segment form]**
...
```
✅ ทำให้ดี:
  1. ชื่อ Template ชัดเจน
  2. ใช้ {name} {product} {price}
  3. ตรวจสอบ Typo
  4. ทดลองก่อนบันทึก
  5. อัปเดตเมื่อแพง-ถูก

❌ อย่าทำ:
  1. Template สั้นเกิน (ลูกค้าพัง)
  2. Hardcode ราคา (ลืมปรับ)
  3. Template เหมือนกับคนอื่น
  4. ใช้ Template เก่าจากปีที่แล้ว
```
...
**[Screenshot: Broadcasts main page]**
...
**[Screenshot: Target audience selection]**
...
**[Screenshot: Broadcast analytics]**
...
**[Screenshot: Settings > Auto-Reply]**
...
```
🌐 Main Portal:      https://reya.example.com
...
```
🌐 Main:         https://reya.example.com
📖 Wiki:         [wiki link]
🎥 Video Tuts:   [youtube link]
💬 Slack Group:  #reya-support
```
...
```
1️⃣ ตรวจสอบ FAQ ในเอกสารนี้
2️⃣ ดูส่วน Troubleshooting
3️⃣ ถามเพื่อน/Lead
4️⃣ ติดต่อ Support: support@company.com
5️⃣ Call Emergency: 02-xxx-xxxx
```

### ผู้ที่สามารถช่วยเหลือ

```
🎯 Admin
   └─ ตั้งค่า, ปัญหาเทคนิค, Permissions
   
🎯 Lead/Team Manager
   └─ Workflow, Strategy, Performance
...
## 📌 Document Improvements (Future)

เอกสารนี้ยังสามารถปรับปรุงได้เพิ่มเติม:

```
1. 🖼️ เพิ่มรูปจริง (Screenshots)
   └─ Dashboard, Inbox, Broadcast creation, Analytics
   
2. 🎥 เพิ่มวิดีโอสั้น ๆ
   └─ 30 sec video per workflow
   
3. 🗺️ สร้าง Flowchart
   └─ "Customer Message → Decision Tree → Action"
   
4. ⌨️ Keyboard Shortcuts
   └─ อยู่บน line แต่ต้องทำให้ visible มากขึ้น
   
5. 📊 Permission Matrix
   └─ Who can do What (Admin vs Staff vs Sales)
   
6. 📖 Glossary
   └─ Terms: Unread, Open, In Progress, Tag vs Segment
```

---

*Last Updated: 2026-04-09 | Reader Tested & Revised*
*Status: ✅ Production Ready (with minor improvements planned)*
