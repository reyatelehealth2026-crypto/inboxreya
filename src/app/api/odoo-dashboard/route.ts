 ...
 * Proxies requests to PHP odoo-webhooks-dashboard.php backend
 * 
 * Supported actions: stats, list, order_timeline, customer_360,
 * webhook_stats_mini, dlq_list, dlq_retry, dlq_stats, customer_list,
 * odoo_orders, odoo_invoices, odoo_slips, odoo_bdos, notification_log
 */
